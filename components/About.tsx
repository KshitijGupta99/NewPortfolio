  ...
  return (
    ...
    >
      <div className="mx-auto max-w-4xl text-white text-center animate-fade-in-up">
        <h2 className="mb-10 font-extrabold text-4xl tracking-tight">
          About Me
        </h2>
        <p className="bg-white/5 shadow-lg backdrop-blur-md p-6 border border-gray-700 rounded-xl text-gray-300 text-lg leading-relaxed tracking-wide">
          I’m a 3rd-year Computer Science student at IIIT Sonepat, driven by a passion for full-stack web development and building intuitive, impactful digital experiences. With strong hands-on experience in the MERN stack and Next.js, I specialize in transforming ideas into seamless, scalable applications with a modern UI/UX focus.

          Over the past few years, I’ve developed projects like real-time chat platforms, contact managers, and crypto dashboards—handling both frontend finesse and backend logic. I thrive in roles that allow me to work across the stack and learn continuously.

          I'm currently the PR Lead at GDG IIIT Sonepat and Content Lead at AlgoZenith, where I actively contribute to organizing tech events and content creation, enhancing both communication and leadership skills. I also dedicate time to solving DSA problems, studying system design, and collaborating in hackathons.
